...
{
#define R_(x)  offsetof(task_state32_t *, x)
    ...
    DECLARE("ISS32_SIZE",    sizeof (task_state32_t));

#define R64_(x)  offsetof(task_state64_t *, x)
    ...
    DECLARE("ISS64_SIZE",    sizeof (task_state64_t));

#define ISF64_(x)  offsetof(interrupt_stack_frame_t *, x)
    ...
    DECLARE("ISF64_SIZE",    sizeof(interrupt_stack_frame_t));
